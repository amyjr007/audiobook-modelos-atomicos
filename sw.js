...
const CACHE = 'audiobook-atomos-b20260706192708'; /* BUILD — carimbado automaticamente pelo git hook */
...
const SHELL = [
  ...
  './audio/dialogo3.4.1A.mp3',
  './audio/dialogo3.4.2.mp3',
  './audio/dialogo3.4.3.mp3',
  './audio/dialogo3.4.4.mp3',
  './audio/dialogo3.4.5.mp3',
  './audio/dialogo3.4.6.mp3',
  './audio/dialogo3.5.mp3',
  './audio/dialogo3.5.1.mp3',
  './audio/dialogo3.5.2.mp3',
  './audio/dialogo3.5.2A.mp3',
  './audio/dialogo3.5.3.mp3',
  './audio/dialogo3.5.4.mp3',
  './audio/dialogo3.5.5.mp3',
  './audio/dialogo3.5.6.mp3',
  './audio/dialogo3.5.7.mp3',
  './audio/dialogo3.5.8.mp3',
  './audio/dialogo4.0.mp3',
  './audio/dialogo4.mp3',
  './audio/dialogo4.1.mp3',
  './audio/dialogo4.2.mp3',
  './audio/dialogo4.3.mp3',
  './audio/dialogo4.4.mp3',
  './audio/dialogo4.5.mp3',
  './audio/dialogo4.5A.mp3',
  './audio/dialogo4.5B.mp3',
  './audio/dialogo4.5C.mp3',
  './audio/dialogo4.5D.mp3',
  './audio/dialogo4.5E.mp3',
  './audio/dialogo4.5F.mp3',
  './audio/dialogo4.5G.mp3',
  './audio/dialogo4.5H.mp3',
  './audio/dialogo4.5I.mp3',
  './audio/dialogo4.6.mp3',
  './audio/dialogo4.7.mp3',
  './audio/dialogo4.8.mp3',
  './audio/dialogo4.9.mp3',
  './audio/dialogo4.10.mp3',
  './audio/dialogo4.11.mp3',
  './audio/raios_catodicos.mp3',
  './audio/click_sound.m4a',
  './audio/click_sound2.mp3',
  './audio/micro_fan.mp3',
  './audio/micro_fan_off.mp3',
  './audio/plates.mp3',
  './audio/proxima.mp3',
  './audio/maisessa.mp3',
  './audio/maisuma.mp3',
  ...
  './images/Imagem3.png',
  './images/thomson.jpg',
  './images/william_crookes.webp',
  './images/paris_lab.png',
  './images/museu_paris.png',
  './images/becquerel.jpg',
  './images/sal_uranio.jpg',
  './images/marie_curie.png',
  './images/manchester.jpg',
  './images/rutherford.png',
  './images/rutherford_team.png'
];
